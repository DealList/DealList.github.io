...
(function () {
  ...
  const COLS = {
    ipo: [
      ...
      {id:"qty",label:"모집 수량(만주)",num:1,cell:r=>fmtMan(r.init_qty),val:r=>r.init_qty,xls:r=>r.init_qty??""},
      {id:"price",label:"1주당 모집 가액(원)",num:1,cell:r=>fmtN(r.init_price),val:r=>r.init_price,xls:r=>r.init_price??""},
      {id:"total",label:"모집 총액(억원)",num:1,cell:r=>fmtN(r.init_total),val:r=>r.init_total,xls:r=>r.init_total??""},
