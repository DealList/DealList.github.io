...
- **비율(%) 표기**: 증자비율·신주비율·구주비율·배정비율 등 비율은 반드시 '%'. 제공값이 "24.87%"·"25%"처럼 % 문자열이면 **자릿수를 바꾸지 말고 그대로** 쓴다('25%'를 '25.0%'로 바꾸거나 반올림하지 말 것). 혹시 0~1 소수로 들어오면 ×100(0.2487 → 24.87%). **'0.x' 소수 형태 절대 금지.**
