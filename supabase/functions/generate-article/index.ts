...
(3) 이후 문단 구성 — 다음 순서를 권장:
   ...
   ⑥ **주관사/인수사 — 금액(실적) 유무에 따라** (특히 ECM. payload '실적_확정' 필드 확인):
      ...
      - **'실적_확정'=false** (최초 증권신고서 단계 — 금액 미정): **이름만** 쓰고 주관 실적·인수 금액 문장은 **생략**한다. 예: "대표주관사는 △A증권 △B증권이다. 인수사로는 △C증권이 참여한다."
      - 인수사_명단이 주관사_명단과 같으면 인수사 문장 생략. 인수사_명단에 주관사 외 추가 증권사가 있으면 **그 추가분만** "인수사로 참여한다"고 언급.
