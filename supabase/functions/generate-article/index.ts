...
(1) **리드 문단 (1~2문장)**:
   ...
   - **'무보증'은 리드에 쓰지 않는다.** 일반 공모채는 대부분 무보증이라 리드에선 "공모 회사채"로만 쓰고, '무보증'이라는 표현은 **리드 다음 문장에서 딱 한 번만** 언급한다.
     - **예외 — 신종자본증권·후순위채 등 특수채**일 때만 그 종류를 리드(및 헤드라인·본문)에 명기한다. (예: "농협금융지주가 3600억원 규모의 신종자본증권을 발행한다.")
