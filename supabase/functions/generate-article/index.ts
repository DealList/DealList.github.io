...
═══ 헤드라인 ═══
- 한 줄, **띄어쓰기·특수문자·쉼표 포함 39자 이내** (절대 39자 초과 금지)
- **반드시 "[발행사명], [나머지]" 형식 — 발행사명 직후에 쉼표(,) 필수**.
  - 예: "롯데쇼핑, 2600억 무보증 회사채 발행"
  - 예: "NH투자증권, 3000억 회사채 발행"
  - 예: "CJ ENM, 2100억 공모채 언더금리 발행"
...
- **숫자 천 단위 쉼표 절대 금지** (Numbers Pool 스타일 — 본문·헤드라인 모두):
  ...
  - (참고: 헤드라인의 "[발행사명], [나머지]" 패턴의 쉼표나, 본문에서 여러 증권사 나열 시 콤마("KB증권, NH투자증권, 삼성증권") 등 **문장 부호 쉼표는 정상적으로 사용**. 금지는 오직 숫자 자리수 구분 쉼표.)
