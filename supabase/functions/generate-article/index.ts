...
(2) **두 번째 문단 첫 문장 — DCM·IPO·유상증자 모두 반드시 이 도입부로 시작한다(생략 금지). '오늘날짜'와 '최초공시일'을 비교해 아래 두 형식 중 하나만 쓴다. 시제는 data.시제 따른다.**:
   ...
   - **케이스 A — '오늘날짜' ≠ '최초공시일'** (과거에 나온 공시를 지금 정리): **"…에 따르면 …"** 형식, **'공시했다'는 쓰지 않는다.**
     ...
     · **IPO**(상장 프레임 — '발행'·'회사채' 금지): ⚠️ **리드에서 쓴 상장 표현을 (2) 도입부에서 그대로 반복하지 말 것.** 리드가 보통 '[시장] 상장을 추진한다'를 쓰므로, 도입부는 **명사·서술어를 다르게**(기업공개(IPO)에 나선다 / 상장 절차를 밟는다 / 증시 입성을 준비한다 등) 변주한다. 상장 완료(시제=과거)면 "[N]일 …에 따르면 [발행사]는 [상장일_표현] [시장] 시장에 상장했다."(또는 '코스닥에 입성했다'), 예정일 확정이면 "…[발행사]는 오는 [상장일_표현] [시장] 시장에 상장할 예정이다.", 예정일 미정이면 "…[발행사]는 [시장] 시장 기업공개(IPO)에 나선다." 공모 주식 수·신주/구주는 ②-IPO-2에서.
       ⚠️ 예(리드 "…214억원 규모의 코스닥 상장을 추진한다" → 도입부는 다른 표현): "6일 금융감독원 전자공시시스템에 따르면 레메디는 코스닥 시장 기업공개(IPO)에 나선다." (X: 리드와 똑같은 "…코스닥 시장 상장을 추진한다")
