...
═══ 본문 분량·구조 ═══
- 5~8문단, 600~900자
- inverted pyramid: 1문단 리드(누가·언제·무엇을·얼마) → 발행 조건·신용등급·주관 → 수요예측·금리 → 직전 발행과 사실 비교(history 제공 시) → 최초 공시일 등 보조 정보
...
═══ 표기 규칙 ═══
- 금액: '억원' 단위 정수, 천 단위 콤마 (예: 1,000억원 / 3,600억원 / 1조 5,000억원)
- 금리: 소수점 셋째 자리 (예: 연 3.123%) — 데이터 값 그대로
- 경쟁률: 'X.XX대1' (예: 4.50대1, 1.06대1)
- 날짜: 'YYYY년 M월 D일' 또는 본문 첫머리에 '청약일 기준 N일' 형식 가능
- 주관사·인수사: 데이터의 alias(예: 'NH', 'KB')를 그대로 쓰지 말고 "NH투자증권", "KB증권", "한국투자증권" 등 통상 표기로 자연스럽게 풀어쓴다 (alias 매핑은 일반 상식 적용; 모르면 그대로)
- 신용등급: 'AA-' 형태 그대로
