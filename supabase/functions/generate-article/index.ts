...
(3) 이후 문단 구성 — 다음 순서를 권장:
   ...
   ②-IPO-0 **(IPO 1주당 희망 발행가액·희망 모집총액 — kind=ipo일 때 항상, 누락 절대 금지)**: ⚠️ **데이터가 빈약한 예정 IPO(수요예측 전·확정 공모가 없음)라도 '1주당 희망 발행가액'과 '희망 모집총액'을 본문에 반드시 한 문장으로 명기한다.** payload '최초_가액_원'(예 7500)을 **1주당** 가격으로, '최초_총액_억'(예 150)·'최초_수량'(예 200만주)을 함께 쓴다. '1주당'을 꼭 붙여 한 주 가격임을 분명히 하고 총액(억원)과 혼동하지 말 것.
      - **분기 — ⑦(조달규모_변화)과 중복 서술 금지(둘 중 하나만)**:
        ...
        · **확정 공모가가 있을 때**(payload '최종_가액_원' 존재 = 수요예측 후): 1주당 희망가액을 여기서 길게 풀지 말고, 가격·총액의 '변화'를 ⑦(조달규모_변화)에서 1주당 공모가(최초_가액_원→최종_가액_원)와 총액 변화로 다룬다. 이 ②-IPO-0 단락은 생략하거나 한 줄로만.
   ...
   ⑦ **(유증·IPO) 조달 규모 변화** — payload '조달규모_변화'(최초희망_억→최종_억, 증감_억)가 있을 때 **가격(확정가)보다 '조달 규모(총액)의 변화'를 핵심으로 쓴다.** ⚠️ **단 IPO(kind=ipo)는 '최종_가액_원'(확정 공모가)이 있을 때만** 이 단락을 쓴다 — 확정가가 없으면(수요예측 전 예정 IPO) 이 단락을 통째로 생략하고 위 ②-IPO-0(1주당 희망가액·희망총액)으로만 다룬다(같은 정보를 ②-IPO-0과 ⑦에 중복 서술 금지). **유증(kind=rights)은 발행가·총액 변화를 위 ②-유증에서 단계별로 모두 다루므로, ⑦은 쓰지 않는다**(⑦은 IPO 전용).
      - "최초 [최초희망_억]억원 조달을 목표로 했으나 확정 발행가가 [최초가]원에서 [확정가]원으로 오르며 최종 [최종_억]억원을 조달한다/했다." 식. 증감_억이 +면 증액(늘어남), −면 감액(줄어듦).
      - ⚠️ **IPO일 때(kind=ipo)는 '증액했다'처럼 딱딱하게 쓰지 말고 소프트하게 푼다** — '늘었다'·'불었다'·'더 조달하게 됐다' 같은 부드러운 동사를 쓰고, 가능하면 '증액'이라는 명사 자체를 피한다. 가격 변화는 **'1주당' 공모가임을 명시**해 한 주 가격임을 분명히 한다(총액과 혼동 금지). IPO에선 payload '최초_가액_원'(희망가 하단)·'최종_가액_원'(확정 공모가)을 1주당 가격으로, '조달규모_변화'(최초희망_억→최종_억, 증감_억)를 총액으로 쓴다.
        예(IPO, 시제=과거): "공모가가 1주당 4만4000원에서 5만5000원으로 높아지며, 조달 규모도 당초 1087억원에서 1358억원으로 271억원가량 늘었다." (X: "271억원 증액했다")
