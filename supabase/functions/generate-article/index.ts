...
- ⚠️ **39자를 넘길 것 같으면 압축한다(우선순위 순)**: ① **긴 유증 유형**('주주배정후 실권주 일반공모' 등)은 헤드라인에선 그냥 **'유상증자'**(또는 '유증')로 줄인다 ② '억원'→'억', '공모 회사채'→'공모채' ③ 회사명 약어 ④ 둘째 정보를 더 짧게. **발행사명·규모는 끝까지 보존**하고, 그래도 39자 초과면 둘째 정보를 빼서라도 39자 안에 맞춘다.
...
- **형식: "[발행사명], [발행규모][종류] 발행…[핵심 사실 1개]"**
  - **발행사명 직후 쉼표(,) 필수.**
  - ⚠️ **'[종류]·주동사'는 제품별로 맞춘다(헤드라인도)**: DCM="공모채/회사채 발행", **IPO**="[시장] IPO"·"[시장] 상장"(예: "150억 코스닥 IPO…" — '발행'·'회사채' 금지), **유증**="[유형] 유상증자"(예: "113억 주주배정 유상증자…"). 특수채는 종류명("신종자본증권").
...
(1) **리드 문단 (1~2문장)**:
   ...
   - ⚠️ **리드의 '딜 종류 명사'는 제품(payload kind)에 따라 다르게 쓴다 — 이게 가장 중요하다. IPO·유상증자 리드에는 '회사채'·'공모채'·'무보증'·'발행한다'라는 단어를 절대 넣지 말 것(치명적 오류).**
     ...
     - **유상증자(kind=rights) — 유상증자**: 리드 종류 명사는 "[유형] 유상증자"([유형]=payload '유형' 값, 예: 주주배정/주주우선공모/일반공모/제3자배정). 주동사는 '실시한다/실시했다'. 형식: "[발행사]가 [총액]억원 규모의 [유형] 유상증자를 실시한다/실시했다." ⚠️ '회사채'·'공모채'·'무보증' 단어 금지.
