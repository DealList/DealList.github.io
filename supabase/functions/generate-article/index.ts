...
- **형식: "[발행사명], [발행규모][종류] 발행…[핵심 사실 1개]"**
  - **발행사명 직후 쉼표(,) 필수.**
  - ⚠️ **'[종류]·주동사'는 제품별로 맞춘다(헤드라인도)**: DCM="공모채/회사채 발행", **IPO**="[시장] IPO"·"[시장] 상장"(예: "150억 코스닥 IPO…" — '발행'·'회사채' 금지), **유증**="유상증자"(⚠️ **유형은 헤드라인에서 뺀다** — 주주배정/실권주 일반공모 등 형태는 뉴스가치 낮음. 둘째 정보는 증자비율·신주 발행량·조달규모 변화로. 예: "739억 유상증자…증자비율 15.32%", "739억 유상증자…850만주 발행"). 특수채는 종류명("신종자본증권").
...
(3) 이후 문단 구성 — 다음 순서를 권장:
   ...
   ②-유증 **(유상증자 1주당 발행가·신주량 — kind=rights일 때 항상, 누락 금지)**: ⚠️ **유상증자도 1주당 발행가와 신주 수량을 본문에 반드시 명기한다(딜 미확정·정보 빈약해도 — 있는 정보를 최대한 적극 활용한다).**
      - **확정 발행가(확정가_원)가 있으면**: 그 확정가를 1주당 발행가로 쓰고, 가격·총액의 '변화'는 ⑦(조달규모 변화)에서 다룬다. 이 단락은 생략하거나 한 줄로.
      - **확정 발행가가 없으면(진행 중)**: payload의 가장 최근 발행가(**2차가_원 > 1차가_원 > 최초가_원** 순으로 있는 값)를 '예정 발행가'로 쓴다. ⚠️ **이 1주당 예정 발행가를 절대 빠뜨리지 말 것.**
        형식: "예정 발행가는 1주당 [발행가]원으로, 신주 [신주_수량]주를 발행해 [해당 총액]억원을 조달할 계획이다." (시제=data.시제, 진행 중이면 '예정'·'계획' 톤)
        예(예정가 1주당 8700원·신주 850만주·739억): "예정 발행가는 1주당 8700원으로, 신주 850만주를 발행해 739억원을 조달할 계획이다."
      - 1차가/2차가가 최초가와 다르면 "예정 발행가는 1주당 [최초가]원에서 [최신가]원으로 조정됐다" 식 변화도 덧붙일 수 있다(데이터 있을 때만).
      - 1주당 가격은 만 단위로 끊고(8700원·2만2000원), 신주 수량은 만/억 붙여쓰기(850만주), 총액은 '억원'. 천단위 쉼표 금지.
   ...
   ⑦ **(유증·IPO) 조달 규모 변화** — payload '조달규모_변화'(최초희망_억→최종_억, 증감_억)가 있을 때 **가격(확정가)보다 '조달 규모(총액)의 변화'를 핵심으로 쓴다.** ⚠️ **단 IPO(kind=ipo)는 '최종_가액_원'(확정 공모가)이 있을 때만** 이 단락을 쓴다 — 확정가가 없으면(수요예측 전 예정 IPO) 이 단락을 통째로 생략하고 위 ②-IPO-0(1주당 희망가액·희망총액)으로만 다룬다(같은 정보를 ②-IPO-0과 ⑦에 중복 서술 금지). **유증(kind=rights)은 종전대로 '조달규모_변화'가 있으면 쓴다**(IPO 게이트와 무관).
